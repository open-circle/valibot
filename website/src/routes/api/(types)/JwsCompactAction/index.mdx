...
description: JWS compact action interface for structural validation.
contributors:
  - yslpn
---
...
Used by `jwsCompact` when structurally validating strings that use JWS compact serialization.
