...
- [number](/api/number/)
- [object](/api/object/)
- [objectWithPatterns](/api/objectWithPatterns/)
...
- [objectWithPatternsAsync](/api/objectWithPatternsAsync/)
...
- [ObjectWithPatternsIssue](/api/ObjectWithPatternsIssue/)
- [ObjectWithPatternsSchema](/api/ObjectWithPatternsSchema/)
- [ObjectWithPatternsSchemaAsync](/api/ObjectWithPatternsSchemaAsync/)
