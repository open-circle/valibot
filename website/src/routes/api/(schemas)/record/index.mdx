...
> If you only need to validate that the input is a plain object and do not need to validate specific keys or values, use <Link href="../pojo/">`pojo`</Link> instead.
