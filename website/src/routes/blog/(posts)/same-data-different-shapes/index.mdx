...
I wrote [doba](https://github.com/karol-broda/doba) to deal with this. It's a schema registry that works with Valibot, and the two pair well for a few reasons.
