...
Valibot includes an agent skill that teaches AI agents the correct patterns for generating Valibot schemas. You can install it by running one of the following commands in your terminal:
