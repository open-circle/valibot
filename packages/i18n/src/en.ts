...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Invalid input: Received ${issue.received}`,
    rawCheck:          (issue) => `Invalid input: Received ${issue.received}`,
    rawCheckAsync:     (issue) => `Invalid input: Received ${issue.received}`,
    rawTransform:      (issue) => `Invalid input: Received ${issue.received}`,
    rawTransformAsync: (issue) => `Invalid input: Received ${issue.received}`,
