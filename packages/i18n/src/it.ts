...
const language: Language = {
  ...
  specific: {
    ...
    isoDateTimeSecond: (issue) => `Data e ora con secondi non validi: Ricevuto ${issue.received}`,
    ...
    partialCheckAsync: (issue) => `Input non valido: Ricevuto ${issue.received}`,
    rawCheck:          (issue) => `Input non valido: Ricevuto ${issue.received}`,
    rawCheckAsync:     (issue) => `Input non valido: Ricevuto ${issue.received}`,
    rawTransform:      (issue) => `Input non valido: Ricevuto ${issue.received}`,
    rawTransformAsync: (issue) => `Input non valido: Ricevuto ${issue.received}`,
