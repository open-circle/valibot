...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Неправильные данные: получено ${issue.received}`,
    rawCheck:          (issue) => `Неправильные данные: получено ${issue.received}`,
    rawCheckAsync:     (issue) => `Неправильные данные: получено ${issue.received}`,
    rawTransform:      (issue) => `Неправильные данные: получено ${issue.received}`,
    rawTransformAsync: (issue) => `Неправильные данные: получено ${issue.received}`,
