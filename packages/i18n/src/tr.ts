...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Geçersiz girdi: ${issue.received} alındı`,
    rawCheck:          (issue) => `Geçersiz girdi: ${issue.received} alındı`,
    rawCheckAsync:     (issue) => `Geçersiz girdi: ${issue.received} alındı`,
    rawTransform:      (issue) => `Geçersiz girdi: ${issue.received} alındı`,
    rawTransformAsync: (issue) => `Geçersiz girdi: ${issue.received} alındı`,
