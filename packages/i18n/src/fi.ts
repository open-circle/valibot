...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Virheellinen syöte: saatiin ${issue.received}`,
    rawCheck:          (issue) => `Virheellinen syöte: saatiin ${issue.received}`,
    rawCheckAsync:     (issue) => `Virheellinen syöte: saatiin ${issue.received}`,
    rawTransform:      (issue) => `Virheellinen syöte: saatiin ${issue.received}`,
    rawTransformAsync: (issue) => `Virheellinen syöte: saatiin ${issue.received}`,
