...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Neplatný vstup: Obdrženo ${issue.received}`,
    rawCheck:          (issue) => `Neplatný vstup: Obdrženo ${issue.received}`,
    rawCheckAsync:     (issue) => `Neplatný vstup: Obdrženo ${issue.received}`,
    rawTransform:      (issue) => `Neplatný vstup: Obdrženo ${issue.received}`,
    rawTransformAsync: (issue) => `Neplatný vstup: Obdrženo ${issue.received}`,
