...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `無効な入力: ${issue.received} を受け取りました`,
    rawCheck:          (issue) => `無効な入力: ${issue.received} を受け取りました`,
    rawCheckAsync:     (issue) => `無効な入力: ${issue.received} を受け取りました`,
    rawTransform:      (issue) => `無効な入力: ${issue.received} を受け取りました`,
    rawTransformAsync: (issue) => `無効な入力: ${issue.received} を受け取りました`,
