...
const language: Language = {
  ...
  specific: {
    ...
    isoDateTimeSecond: (issue) => `Ogiltig datum-tid med sekunder: Fick ${issue.received}`,
    ...
    partialCheckAsync: (issue) => `Ogiltig indata: Fick ${issue.received}`,
    rawCheck:          (issue) => `Ogiltig indata: Fick ${issue.received}`,
    rawCheckAsync:     (issue) => `Ogiltig indata: Fick ${issue.received}`,
    rawTransform:      (issue) => `Ogiltig indata: Fick ${issue.received}`,
    rawTransformAsync: (issue) => `Ogiltig indata: Fick ${issue.received}`,
