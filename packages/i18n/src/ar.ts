...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `مُدخل غير صالح: القيمة المُدخلة ${issue.received}`,
    rawCheck:          (issue) => `إدخال غير صالح: القيمة المُدخلة ${issue.received}`,
    rawCheckAsync:     (issue) => `إدخال غير صالح: القيمة المُدخلة ${issue.received}`,
    rawTransform:      (issue) => `إدخال غير صالح: القيمة المُدخلة ${issue.received}`,
    rawTransformAsync: (issue) => `إدخال غير صالح: القيمة المُدخلة ${issue.received}`,
