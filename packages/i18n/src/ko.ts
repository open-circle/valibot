...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `부분적으로 유효하지 않은 입력: ${issue.received} 을(를) 받았습니다`,
    rawCheck:          (issue) => `유효하지 않은 입력: ${issue.received} 을(를) 받았습니다`,
    rawCheckAsync:     (issue) => `유효하지 않은 입력: ${issue.received} 을(를) 받았습니다`,
    rawTransform:      (issue) => `유효하지 않은 입력: ${issue.received} 을(를) 받았습니다`,
    rawTransformAsync: (issue) => `유효하지 않은 입력: ${issue.received} 을(를) 받았습니다`,
