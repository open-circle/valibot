...
const language: Language = {
  ...
  specific: {
    ...
    isoDateTimeSecond: (issue) => `Dată-timp cu secunde incorect: S-a introdus ${issue.received}`,
    ...
    partialCheckAsync: (issue) => `Intrare incorectă: S-a introdus ${issue.received}`,
    rawCheck:          (issue) => `Intrare incorectă: S-a introdus ${issue.received}`,
    rawCheckAsync:     (issue) => `Intrare incorectă: S-a introdus ${issue.received}`,
    rawTransform:      (issue) => `Intrare incorectă: S-a introdus ${issue.received}`,
    rawTransformAsync: (issue) => `Intrare incorectă: S-a introdus ${issue.received}`,
