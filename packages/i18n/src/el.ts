...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Λάθος είσοδος: Ήρθε ${issue.received}`,
    rawCheck:          (issue) => `Λάθος είσοδος: Ήρθε ${issue.received}`,
    rawCheckAsync:     (issue) => `Λάθος είσοδος: Ήρθε ${issue.received}`,
    rawTransform:      (issue) => `Λάθος είσοδος: Ήρθε ${issue.received}`,
    rawTransformAsync: (issue) => `Λάθος είσοδος: Ήρθε ${issue.received}`,
