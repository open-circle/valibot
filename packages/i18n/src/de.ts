...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Ungültige Eingabe: ${issue.received} erhalten`,
    rawCheck:          (issue) => `Ungültige Eingabe: ${issue.received} erhalten`,
    rawCheckAsync:     (issue) => `Ungültige Eingabe: ${issue.received} erhalten`,
    rawTransform:      (issue) => `Ungültige Eingabe: ${issue.received} erhalten`,
    rawTransformAsync: (issue) => `Ungültige Eingabe: ${issue.received} erhalten`,
