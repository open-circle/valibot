...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Valor inválido: Se recibió ${issue.received}`,
    rawCheck:          (issue) => `Entrada inválida: Se recibió ${issue.received}`,
    rawCheckAsync:     (issue) => `Entrada inválida: Se recibió ${issue.received}`,
    rawTransform:      (issue) => `Entrada inválida: Se recibió ${issue.received}`,
    rawTransformAsync: (issue) => `Entrada inválida: Se recibió ${issue.received}`,
