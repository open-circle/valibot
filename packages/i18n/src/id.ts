...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Input tidak valid: Menerima ${issue.received}`,
    rawCheck:          (issue) => `Input tidak valid: Menerima ${issue.received}`,
    rawCheckAsync:     (issue) => `Input tidak valid: Menerima ${issue.received}`,
    rawTransform:      (issue) => `Input tidak valid: Menerima ${issue.received}`,
    rawTransformAsync: (issue) => `Input tidak valid: Menerima ${issue.received}`,
