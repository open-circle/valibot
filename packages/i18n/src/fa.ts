...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `ورودی نامعتبر: ${issue.received} دریافت شد`,
    rawCheck:          (issue) => `ورودی نامعتبر: ${issue.received} دریافت شد`,
    rawCheckAsync:     (issue) => `ورودی نامعتبر: ${issue.received} دریافت شد`,
    rawTransform:      (issue) => `ورودی نامعتبر: ${issue.received} دریافت شد`,
    rawTransformAsync: (issue) => `ورودی نامعتبر: ${issue.received} دریافت شد`,
