...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Neveljaven input: Prejet ${issue.received}`,
    rawCheck:          (issue) => `Neveljaven vnos: Prejet ${issue.received}`,
    rawCheckAsync:     (issue) => `Neveljaven vnos: Prejet ${issue.received}`,
    rawTransform:      (issue) => `Neveljaven vnos: Prejet ${issue.received}`,
    rawTransformAsync: (issue) => `Neveljaven vnos: Prejet ${issue.received}`,
