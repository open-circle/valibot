...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Valor invàlid: S'ha rebut ${issue.received}`,
    rawCheck:          (issue) => `Entrada invàlida: S'ha rebut ${issue.received}`,
    rawCheckAsync:     (issue) => `Entrada invàlida: S'ha rebut ${issue.received}`,
    rawTransform:      (issue) => `Entrada invàlida: S'ha rebut ${issue.received}`,
    rawTransformAsync: (issue) => `Entrada invàlida: S'ha rebut ${issue.received}`,
