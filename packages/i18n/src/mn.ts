...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Буруу утга: ${issue.received} ирлээ`,
    rawCheck:          (issue) => `Буруу утга: ${issue.received} ирлээ`,
    rawCheckAsync:     (issue) => `Буруу утга: ${issue.received} ирлээ`,
    rawTransform:      (issue) => `Буруу утга: ${issue.received} ирлээ`,
    rawTransformAsync: (issue) => `Буруу утга: ${issue.received} ирлээ`,
