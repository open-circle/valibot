...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Đầu vào không hợp lệ: Nhận được ${issue.received}`,
    rawCheck:          (issue) => `Đầu vào không hợp lệ: Nhận được ${issue.received}`,
    rawCheckAsync:     (issue) => `Đầu vào không hợp lệ: Nhận được ${issue.received}`,
    rawTransform:      (issue) => `Đầu vào không hợp lệ: Nhận được ${issue.received}`,
    rawTransformAsync: (issue) => `Đầu vào không hợp lệ: Nhận được ${issue.received}`,
