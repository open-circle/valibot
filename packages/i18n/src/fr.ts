...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Valeur invalide: reçu ${issue.received}`,
    rawCheck:          (issue) => `Entrée invalide: reçu ${issue.received}`,
    rawCheckAsync:     (issue) => `Entrée invalide: reçu ${issue.received}`,
    rawTransform:      (issue) => `Entrée invalide: reçu ${issue.received}`,
    rawTransformAsync: (issue) => `Entrée invalide: reçu ${issue.received}`,
