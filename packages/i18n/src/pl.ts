...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Nieprawidłowe dane: Otrzymano ${issue.received}`,
    rawCheck:          (issue) => `Nieprawidłowe dane: Otrzymano ${issue.received}`,
    rawCheckAsync:     (issue) => `Nieprawidłowe dane: Otrzymano ${issue.received}`,
    rawTransform:      (issue) => `Nieprawidłowe dane: Otrzymano ${issue.received}`,
    rawTransformAsync: (issue) => `Nieprawidłowe dane: Otrzymano ${issue.received}`,
