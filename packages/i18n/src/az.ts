...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Yanlış giriş: Alınan ${issue.received}`,
    rawCheck:          (issue) => `Yanlış giriş: Alınan ${issue.received}`,
    rawCheckAsync:     (issue) => `Yanlış giriş: Alınan ${issue.received}`,
    rawTransform:      (issue) => `Yanlış giriş: Alınan ${issue.received}`,
    rawTransformAsync: (issue) => `Yanlış giriş: Alınan ${issue.received}`,
