...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Érvénytelen bemenet: ${issue.received} kapott`,
    rawCheck:          (issue) => `Érvénytelen bemenet: ${issue.received} kapott`,
    rawCheckAsync:     (issue) => `Érvénytelen bemenet: ${issue.received} kapott`,
    rawTransform:      (issue) => `Érvénytelen bemenet: ${issue.received} kapott`,
    rawTransformAsync: (issue) => `Érvénytelen bemenet: ${issue.received} kapott`,
