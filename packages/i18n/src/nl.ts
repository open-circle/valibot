...
const language: Language = {
  ...
  specific: {
    ...
    partialCheckAsync: (issue) => `Ongeldige invoer: ${issue.received} ontvangen`,
    rawCheck:          (issue) => `Ongeldige invoer: ${issue.received} ontvangen`,
    rawCheckAsync:     (issue) => `Ongeldige invoer: ${issue.received} ontvangen`,
    rawTransform:      (issue) => `Ongeldige invoer: ${issue.received} ontvangen`,
    rawTransformAsync: (issue) => `Ongeldige invoer: ${issue.received} ontvangen`,
