  ...
  describe('should return dataset with issues', () => {
    ...
    test('for double separators', () => {
      expectActionIssue(action, baseIssue, [
        '0000--01-01T00:00:00',
        '0000-01--01T00:00:00',
        '0000-01-01TT00:00:00',
        '0000-01-01T00::00:00',
        '0000-01-01T00:00::00',
      ]);
    });

    test('for lowercase date/time separator', () => {
      expectActionIssue(action, baseIssue, [
        '0000-01-01t00:00:00',
        '2023-07-11t19:34:56',
        '9999-12-31t23:59:59',
    ...
    test('for timezone designators', () => {
      expectActionIssue(action, baseIssue, [
        ...
        '2023-07-11T19:34:56Z',
        '9999-12-31T23:59:59Z',
        // Lowercase UTC designator
        '2023-07-11T19:34:56z',
        // '+hh:mm'
        '2023-07-11T19:34:56+00:00',
        '2023-07-11T19:34:56+12:34',
        // '+hhmm'
        '2023-07-11T19:34:56+0000',
        '2023-07-11T19:34:56+1234',
        // '+hh'
        '2023-07-11T19:34:56+00',
        '2023-07-11T19:34:56+12',
        // '-hh:mm'
        '2023-07-11T19:34:56-00:00',
        '2023-07-11T19:34:56-12:34',
        // '-hhmm'
    ...
    test('for fractional seconds', () => {
      expectActionIssue(action, baseIssue, [
        '2023-07-11T19:34:56.0',
        '2023-07-11T19:34:56.00',
        '2023-07-11T19:34:56.000',
        '2023-07-11T19:34:56.999999999',
        // Comma as decimal separator
        '2023-07-11T19:34:56,000',
        // With timezone
        '2023-07-11T19:34:56.000Z',
        '2023-07-11T19:34:56.000+00:00',
      ]);
    });
  });
});
